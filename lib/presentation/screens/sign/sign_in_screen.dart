        ...
        listener: (context, state) async {
          if (state is UserSignInChakecdState) {
            ...
            Navigator.pushReplacement(
                context, MaterialPageRoute(builder: (BuildContext context) => MainPage(selectedIndex: 0)));
          ...
          child: Column(
            ...
            children: [
              SizedBox(
                  ...
                  child: Text(
                    "Hello Again!\nWelcome\nBack",
                    style: TextStyle(fontSize: 40, color: Color(0xff000080), fontWeight: FontWeight.w500),
                  )),
              SizedBox(
                height: 80,
              ),
              ...
              CustomButton(
                  ...
                  onPressed: () {
                    ...
                    //   signInBloc.add(UserSignInSendDataEvent(
                    //       context: context, emile: emailController.text, password: passwordController.text));
                    // }
                    Navigator.pushReplacement(
                        context,
                        MaterialPageRoute(
              ...
              Row(
                children: [
                  TextButton(
                      onPressed: () {
                        Navigator.pushNamed(context, MainRoutes.forgotPassword);
                      },
                      child: Text(
                  ...
                  TextButton(
                      ...
                      child: Text('Sign up', style: TextStyle(color: Color(0xff000080))))
                ],
              )
            ],
          ),
